        ...
        <nav class="bg-gray-800">
                    ...
                    <div class="ml-4 flex gap-2 items-center md:ml-6">
                        ...
                        @auth
                            <form method="POST" action="/logout">
                                @csrf
                                <button type="submit" class="text-gray-200 py-2 px-4 rounded font-semibold text-sm">Logout</button>
                            </form>
                        ...
                        @guest
                            ...
                            <x-nav-link heading="Register"  :active="request()->is('register')" href="/register">Register</x-nav-link>
                            <x-nav-link heading="Login"  :active="request()->is('login')" href="/login">Login</x-nav-link>
            ...
            <div class="md:hidden" id="mobile-menu">
                ...
                <div class="flex items-center px-5">
                    ...
                    <div class="text-sm font-medium leading-none text-gray-400">larytherobot@laracasts.com</div>
                    </div>
